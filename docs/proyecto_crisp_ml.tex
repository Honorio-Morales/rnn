...
\begin{itemize}
    \item \textbf{Fuente}: Tatoeba Project (dataset público de traducción)
    \item \textbf{Pares de frases}: 50,000 (español-inglés)
    \item \textbf{Lenguaje}: Frases cortas a medianas (máximo 30 tokens)
...
\begin{table}[H]
    ...
    \begin{tabular}{lrr}
        ...
        \midrule
        Palabras únicas & 8,500 & 7,200 \\
        Longitud promedio (tokens) & 8.5 & 8.2 \\
        Longitud máxima & 45 & 42 \\
        Longitud mínima & 1 & 1 \\
        \bottomrule
    \end{tabular}
    \caption{Estadísticas del corpus paralelo}
\end{table}
...
\subsection{4.1 Métrica Principal: BLEU Score}
...
\subsection{4.3 Análisis de Errores}
...
\subsection{4.4 Resultados Esperados}

Se espera alcanzar:
\begin{itemize}
    \item BLEU Score: 0.35-0.42
